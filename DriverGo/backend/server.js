/**
 * Basic Express backend that:
 * - Verifies Firebase ID tokens from clients using Firebase Admin SDK
 * - Exposes endpoints for drivers, bookings, and Razorpay order creation
 * - Stores data in PostgreSQL (simple queries using 'pg' pool)
 *
 * NOTE: This is a compact, readable starter. Extend, add validation, error handling, and production hardening.
 */
